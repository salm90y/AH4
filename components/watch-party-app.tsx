    ...
    <ScreenContainer className="" edges={["top", "left", "right", "bottom"]}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.roomScreen}>
        ...
        <View style={styles.playerWrap}>
          <NativeMediaPlayer canControl={room?.permissions.includes("control_playback") ?? false} onVolumeChange={setVideoVolume} roomAccessToken={room?.accessToken ?? ""} roomCode={room?.code ?? ""} sourceUrl={room?.sourceUrl ?? null} volume={videoVolume} />
        </View>
